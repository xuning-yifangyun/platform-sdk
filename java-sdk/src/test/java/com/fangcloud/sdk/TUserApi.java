...
public class TUserApi {
    ...
    public void TgetMeInfo(){
        ...
        UserApi userApi=new UserApi(connection);
        GetUserInfoOutput getUserInfoOutput=userApi.getOwnInfo();
    ...
    public void TgetMUserInfo(){
        connection.setAccessToken(Config.TestAccessToken);
        UserApi userApi=new UserApi(connection);
        GetUserInfoOutput getUserInfoOutput=userApi.getUserInfo(22149);
        System.out.println(getUserInfoOutput.getName());
    }
